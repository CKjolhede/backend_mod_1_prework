...
hp = "Harry Potter must not return to Hogwards!"
p hp
...
# Explain.
# 'first_name' would be a set of text characters, so string data was used
# 'is_hungry' was a true/false condition so boolean data type was used.
# 'number of pets' would be a whole number so integer was used
